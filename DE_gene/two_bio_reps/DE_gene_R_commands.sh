...
setwd("/Users/pjt6/Documents/RNAseq_workshop/DE_gene/two_bio_reps")
...
# filter very low expression genes as these do not contribute and negatively 
# affect the stats
...
# GLM is the best approach to use if you have 2 or more factors in your exp design
...
# this is the stats test used to compare these using 1 factor. 
# Anymore you need to use a GLM
